...
import { rewardsAPI, testsAPI, studySessionsAPI } from '@/lib/api';
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">Generate New Test</span>
          </Link>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">Upload Homework</span>
          </Link>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-700">Upload Class Notes</span>
          </Link>
